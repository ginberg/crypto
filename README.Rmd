...
The first argument is the **inputId**, you will find this parameter in all inputs since each input should be unique. Furthermore this inputId is important since we will use it in the server to reference this input. The next argument is the label, this one is also found in most input elements and the contents of this field will be showed on our page.
