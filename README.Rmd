...
You can do quite a lot with Shiny: think of it as an easy way to make an interactive web page, and that web page can interact with R and display R objects (tables, plots or anything else you do in R). To get a sense of the wide range of things you can do with Shiny, you can visit [my Shiny server](gerinberg.com/shiny), which hosts some of my Shiny apps.
...
![Run App button.](basic_shiny.png)
...
[Download it]() now and place this file in the same folder as your Shiny app. Make sure the file is named crypto-data.csv.
