...
In my own cryptocurrency dashboard I am not using a static dataset, but data directly from the the website coinmarketcap. If you are interested on how to do this, please see the code of my own crypto dashboard in the [advanced folder](https://raw.githubusercontent.com/ginberg/crypto/master/advanced)
